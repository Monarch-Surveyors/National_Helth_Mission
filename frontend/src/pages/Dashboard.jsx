...
function Dashboard() {
  ...
  const computedMetrics = useMemo(() => {
    ...
    return {
      ...
      scopeSubtitle: 'Statewide Health Network'
    };
  }, [overview, selectedDistrict, districtFacilities, districtOffices, districtLand]);
        ...
        <div className="page-header-top">
          <div>
            ...
            <p className="page-subtitle">
              Public Health Department • Executive Overview Baseline
            </p>
          </div>
